  ...
  return (
    <div className="p-10 text-right ">
      ...
      >
            ...
            {pageItems.map((content) => (
              <tr key={content.id}>
                ...
                <td>
                  ...
                  <button className="-translate-x-2 translate-y-2 " onClick={() => removeItem(content.id)}>
                    <Trash color="#FF3F3F" />
                  </button>
                </td>
              </tr>
        ...
        <ul className="flex mt-5 justify-center rounded-md overflow-hidden">
          {pagesNumber.map((page) => (
            <li
              ...
              } bg-gray-300 hover:text-white py-2 px-3 hover:bg-gray-400 cursor-pointer first:rounded-s-md last:rounded-e-md`}
            >
              <span>{page + 1}</span>
            </li>
          ))}
